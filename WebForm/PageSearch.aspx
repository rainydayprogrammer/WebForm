<%@ Page Title="ページ内検索" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PageSearch.aspx.cs" Inherits="WebForm.PageSearch" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <h2>ページ内検索</h2>
    <h3>テーブル1</h3>
    <asp:GridView ID="GridView1" runat="server" CssClass="table" BorderColor="#CCCCCC" AutoGenerateColumns="False" DataSourceID="ObjectDataSource1" OnRowDataBound="GridView1_RowDataBound">
        <Columns>
    ...
    <h3>テーブル2</h3>
    <asp:GridView ID="GridView2" runat="server" CssClass="table" BorderColor="#cccccc" AutoGenerateColumns="False" DataSourceID="ObjectDataSource2">
        <Columns>
    ...
    <asp:GridView ID="GridView3" runat="server" CssClass="table" BorderColor="#cccccc" AutoGenerateColumns="False" DataSourceID="ObjectDataSource3">
        <Columns>
            <asp:BoundField DataField="Id" HeaderText="Id" SortExpression="Id" />
            <asp:BoundField DataField="Name" HeaderText="Name" SortExpression="Name" />
        </Columns>
